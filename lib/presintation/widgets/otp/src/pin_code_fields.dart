...
class _PinCodeTextFieldState extends State<PinCodeTextField>
  ...
  TextStyle get _hintStyle => _textStyle
      .copyWith(color: _pinTheme.disabledColor)
  ...
  Future<void> _showPasteDialog(String pastedText) {
    final String formattedPastedText = pastedText.trim().substring(
      0,
    ...
    Directionality textField = Directionality(
      ...
      child: Padding(
        ...
        child: TextFormField(
          ...
          autofillHints:
              widget.enablePinAutofill && widget.enabled
      ...
      result.add(
        Container(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              color:
                  widget.enableActiveFill
                      ? _getFillColorFromIndex(i)
                      : Colors.transparent,
              boxShadow:
                  (_pinTheme.activeBoxShadows != null ||
                          _pinTheme.inActiveBoxShadows != null)
                      ? _getBoxShadowFromIndex(i)
                      : widget.boxShadows,
              shape:
                  _pinTheme.shape == PinCodeFieldShape.circle
                      ? BoxShape.circle
                      : BoxShape.rectangle,
              borderRadius: borderRadius,
              border:
  ...
  void _setTextToInput(String data) async {
    List<String> replaceInputList = List<String>.filled(widget.length, '');
